    ...
    return (
        <div className="max-w-7xl mx-auto px-2 sm:px-2 lg:px-2 py-10 text-center ">
            <div className="px-4 py-4">
                ...
                <h2 className="sm:text-4xl text-3xl font-extrabold text-white-900 mb-4">About Me</h2>
                <p className="mt-4 text-md ">Hi, my name is Lucien Shema, Software Developer, and cyber security enthusiast with knowledge of numerous
            ...
            <div className="flex flex-wrap justify-center lg:flex-nowrap">
                <div className="w-full md:w-1/3 lg:w-auto rounded-lg overflow-hidden shadow-md mx-1 my-1">
